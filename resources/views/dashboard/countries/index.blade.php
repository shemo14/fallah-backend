...
@section('content')
    ...
    <div class="btn-group btn-group-justified m-b-10">
        <a href="#add" class="btn btn-success waves-effect btn-lg waves-light" data-animation="fadein" data-plugin="custommodal"
            data-overlaySpeed="100" data-overlayColor="#36404a">اضافة مدينة جديدة <i class="fa fa-plus"></i> </a>
                ...
                <table id="datatable" class="table table-bordered table-responsives">
                    ...
                    @foreach($countries as $country)
                        <tr>
                            <td>
                                <label class="custom-control material-checkbox" style="margin: auto">
                                    <input type="checkbox" class="material-control-input checkSingle" id="{{$country->id}}">
                                    <span class="material-control-indicator"></span>
                                </label>
                            </td>
                            <td>{{$country->id}}</td>
    ...
    <div id="edit" class="modal-demo">
        ...
        <form id="edit" action="{{route('updateCountry')}}" method="post" autocomplete="off" enctype="multipart/form-data">
            {{csrf_field()}}
    ...
    <div id="delete" class="modal-demo" style="position:relative; right: 32%">
        ...
        <h4 class="custom-modal-title">حذف المدينة</h4>
